...
let colors = [
    ...
    "DefaultThemeDark" : UIColor(red: 0, green: 0, blue: 0, alpha: 1.00),
    "FireThemeDark" : UIColor(red: 0.75, green: 0.46, blue: 0.29, alpha: 1.00),
    "WaterThemeDark" : UIColor(red: 0.33, green: 0.39, blue: 0.45, alpha: 1.00),
    "GrassThemeDark" : UIColor(red: 0.30, green: 0.45, blue: 0.27, alpha: 1.00)
]
